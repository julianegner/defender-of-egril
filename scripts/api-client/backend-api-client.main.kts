...
if (rootResponse.status == -1) {
    ...
    System.err.println()
    System.err.println("The backend depends on Keycloak being healthy before it starts.")
    System.err.println("Check container status with:  docker ps")
    System.err.println()
    System.err.println("  If Keycloak shows '(health: starting)' wait ~1-2 minutes for it to")
    System.err.println("  finish importing the realm, then the backend will start automatically.")
    System.err.println()
    System.err.println("  If nothing is running at all, start everything from the repo root:")
    System.err.println("    docker compose up -d")
    System.err.println()
    System.err.println("  Or start only the backend (skips Docker):")
    System.err.println("    ./gradlew :server:run")
    System.err.println()
