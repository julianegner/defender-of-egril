...
class ApplicationTest {
    ...
    @Test
    fun testPostEventAppStartedWithUrl() =
        testApplication {
            application {
                module()
            }
    ...
    @Test
    fun testPostEventWithUnknownFields() =
        testApplication {
            application {
                module()
            }
    ...
    @Test
    fun testPostEventMalformedJson() =
        testApplication {
            application {
                module()
            }
    ...
    @Test
    fun testPostFeedbackNoDatabaseReturns503() =
        testApplication {
            application { module() }
            client
                .post("/api/feedback") {
    ...
    @Test
    fun testPostFeedbackBugReportRequiresScreenshotAndLog() =
        testApplication {
            application { module() }
            client
                .post("/api/feedback") {
    ...
    @Test
    fun testPostFeedbackBugReportAcceptsScreenshotAttachment() =
        testApplication {
            application { module() }
            client
                .post("/api/feedback") {
    ...
    @Test
    fun testPostCrashNoDatabaseReturns503() =
        testApplication {
            application { module() }
            client
                .post("/api/crash") {
    ...
    @Test
    fun testPostCrashInvalidUuidReturns400() =
        testApplication {
            application { module() }
            client
                .post("/api/crash") {
    ...
    @Test
    fun testPostCrashBlankErrorTypeReturns400() =
        testApplication {
            application { module() }
            client
                .post("/api/crash") {
    ...
    @Test
    fun testPostCrashMalformedJsonReturns400() =
        testApplication {
            application { module() }
            client
                .post("/api/crash") {
    ...
    @Test
    fun testUploadSavefileRequiresAuth() =
        testApplication {
            application { module() }
            client
                .post("/api/savefiles") {
    ...
    @Test
    fun testUploadSavefileWithFakeTokenNoDatabase() =
        testApplication {
            application { module() }
    ...
    @Test
    fun testListSavefilesRequiresAuth() =
        testApplication {
            application { module() }
    ...
    @Test
    fun testListSavefilesWithFakeTokenNoDatabase() =
        testApplication {
            application { module() }
            val fakeToken = "eyJhbGciOiJub25lIn0.eyJzdWIiOiJ1c2VyLTEyMyJ9."
            client
    ...
    @Test
    fun testUploadSavefileMalformedJson() =
        testApplication {
            application { module() }
            val fakeToken = "eyJhbGciOiJub25lIn0.eyJzdWIiOiJ1c2VyLTEyMyJ9."
            client
    ...
    @Test
    fun testBackchannelLogoutWithValidToken() =
        testApplication {
            application { module() }
    ...
    @Test
    fun testBackchannelLogoutMissingToken() =
        testApplication {
            application { module() }
    ...
    @Test
    fun testBackchannelLogoutMalformedToken() =
        testApplication {
            application { module() }
