 ...
 *
 * @param eventType The type of event (APP_STARTED, APP_CLOSED, TUTORIAL_DEEP_LINK, LEVEL_STARTED, LEVEL_LOADED, LEVEL_WON, LEVEL_LOST, LEVEL_LEFT, GAME_WON)
 * @param levelName Display name of the current level when applicable, or null for app-level events
