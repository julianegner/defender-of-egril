...
class RaftSystem(
     ...
     */
    private fun getNextPositionInDirection(
        pos: Position,
        direction: RiverFlow,
    ): Position {
     ...
     */
    private fun destroyRaftAndTower(
        raft: Raft,
        defender: Defender,
        reason: RaftLossReason = RaftLossReason.OTHER,
    ) {
        destroyRaft(raft)
