...
enum class InfoType {
    ...
    SPIKE_BARBS_INFO, // Spike barbs unlocked at level 10 (spike tower)
...
data class InfoState(
     ...
     */
    fun shouldShowOverlay(): Boolean = currentInfo != InfoType.NONE

    /**
     * Check if an info has been seen
     */
    fun hasSeen(type: InfoType): Boolean = type in seenInfos
     ...
     */
    fun clearSeenInfos(): InfoState = copy(seenInfos = emptySet())
}
