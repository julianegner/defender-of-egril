...
data class PlayerAbilities(
    ...
    companion object {
        ...
        fun getXPForNextLevel(currentLevel: Int): Int = getXPForLevel(currentLevel + 1)

        fun getXPProgressInCurrentLevel(
            totalXP: Int,
            currentLevel: Int,
        ): Int {
