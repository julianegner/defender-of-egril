...
object FinalCreditsData {
     ...
     */
    val contributors: List<ContributorEntry> =
        listOf(
     ...
     */
    val soundEffectsCredits: List<SoundCreditEntry> =
        listOf(
     ...
     */
    val backgroundMusicCredits: List<SoundCreditEntry> =
        listOf(
     ...
     */
    val softwareCredits: List<SoftwareCreditEntry> =
        listOf(
            SoftwareCreditEntry(
     ...
     */
    val specialThanks: List<SpecialThanksEntry> =
        listOf(
            SpecialThanksEntry(
     ...
     */
    val backgroundImageNames: List<String> =
        listOf(
     ...
     */
    val backgroundImageExclusions: Set<String> =
        setOf(
