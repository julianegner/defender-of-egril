...
class GameEngine(
    ...
    private val movementCoordinator =
        GameEngineMovementCoordinator(
            state = state,
            ...
            calculateEffectiveEnemySpeed = ::calculateEffectiveEnemySpeed,
            ...
            recordDragonLevelChange = ::recordDragonLevelChange,
        )
    ...
    private fun handleBarricades(
        ...
        val maxIterations = 10 // Safety limit (original code had 3, but we support more)
        var iteration = 0
    ...
    fun applyMovement(
        ...
        movementCoordinator.applyMovement(attackerId, newPosition)
    }
     ...
     */
    fun calculateNewlySpawnedMovements(): List<List<Pair<Int, Position>>> = movementCoordinator.calculateNewlySpawnedMovements()
