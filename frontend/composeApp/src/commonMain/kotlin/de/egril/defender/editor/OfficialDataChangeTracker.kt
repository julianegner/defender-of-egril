...
object OfficialDataChangeTracker {
     ...
     */
    fun hasModifiedOfficialData(): Boolean = modifiedOfficialMaps.isNotEmpty() || modifiedOfficialLevels.isNotEmpty()

    /**
     * Get list of modified official map IDs
     */
    fun getModifiedOfficialMaps(): List<String> = modifiedOfficialMaps.toList()

    /**
     * Get list of modified official level IDs
     */
    fun getModifiedOfficialLevels(): List<String> = modifiedOfficialLevels.toList()
