...
object AchievementDefinitions {
    ...
    val allAchievements =
        listOf(
            ...
            AchievementInfo(
                AchievementId.LOSE_RAFT_MAELSTROM,
                "achievement_lose_raft_maelstrom_name",
                "achievement_lose_raft_maelstrom_desc",
            ),
            // Level achievements
            ...
            AchievementInfo(
                ...
                "achievement_kill_two_enemies_same_turn_name",
                "achievement_kill_two_enemies_same_turn_desc",
            ),
            AchievementInfo(
                AchievementId.KILL_TWO_ENEMIES_SAME_ATTACK,
                "achievement_kill_two_enemies_same_attack_name",
                "achievement_kill_two_enemies_same_attack_desc",
            ),
            ...
            AchievementInfo(
                AchievementId.REDUCE_DRAGON_LEVEL,
                "achievement_reduce_dragon_level_name",
                "achievement_reduce_dragon_level_desc",
            ),
            AchievementInfo(
                AchievementId.INCREASE_DRAGON_LEVEL,
                "achievement_increase_dragon_level_name",
                "achievement_increase_dragon_level_desc",
            ),
            ...
            AchievementInfo(
                AchievementId.ADD_HEALTH_BARRICADE,
                "achievement_add_health_barricade_name",
                "achievement_add_health_barricade_desc",
            ),
            // XP and stat achievements
            ...
            AchievementInfo(
                AchievementId.CONSTRUCTION_LEVEL_3,
                "achievement_construction_level_3_name",
                "achievement_construction_level_3_desc",
            ),
     ...
     */
    fun getInfo(id: AchievementId): AchievementInfo? = allAchievements.find { it.id == id }
}
