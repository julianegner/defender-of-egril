 ...
 */
actual fun createBackgroundMusicManager(): BackgroundMusicManager = DesktopBackgroundMusicManager()
    ...
    private fun updateVolume(
        ...
        try {
            ...
            if (audioClip.isControlSupported(FloatControl.Type.MASTER_GAIN)) {
                ...
                println(
                    "Set music gain to $gain dB (effectiveVolume=$effectiveVolume, category=$categoryVolume, track=$trackVolume, base=$baseMultiplier, min=${gainControl.minimum}, max=${gainControl.maximum})",
                )
            } else {
