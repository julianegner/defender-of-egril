...
class GameViewModelStickerTest {
    @Test
    fun testStickerCheatCodeNavigatesToStickerScreen() =
        runBlocking {
    ...
    @Test
    fun testStickerCheatCodeIsCaseInsensitive() =
        runBlocking {
            val viewModel = GameViewModel()
    ...
    @Test
    fun testStickerCheatCodeWithExtraWhitespace() =
        runBlocking {
            val viewModel = GameViewModel()
