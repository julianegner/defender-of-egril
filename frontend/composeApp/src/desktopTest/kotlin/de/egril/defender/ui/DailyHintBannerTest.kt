...
class DailyHintBannerTest {
    ...
    fun testDailyHintBannerAppearsOnFirstEntry() {
        ...
        composeTestRule.onNodeWithText("Daily Hint", substring = true, ignoreCase = true)
            .assertExists()
    ...
    fun testDailyHintBannerDoesNotAppearIfAlreadyShownToday() {
        ...
        val today = de.egril.defender.ui.worldmap.todayLocalDateString()
    ...
    fun testDailyHintBannerHiddenForAuthenticatedAccountHint() {
        ...
        composeTestRule.onNodeWithText("Create a free Egril account", substring = true, ignoreCase = true)
            .assertDoesNotExist()
    }
}
