...
class MainMenuScreenTest {
    ...
    fun testMainMenuHasExitButton() {
        ...
        composeTestRule
            .onNodeWithText("Exit Game", substring = true, ignoreCase = true)
            .assertExists()
            .assertHasClickAction()
    }
    ...
    fun testExitButtonShowsConfirmationDialog() {
        ...
        composeTestRule
            .onNodeWithText("Are you sure you want to exit", substring = true, ignoreCase = true)
            .assertExists()
        ...
        composeTestRule
            .onAllNodesWithText("Exit", useUnmergedTree = false)
    ...
    fun testVersionTextIsClickableAndShowsCommitInfo() {
        ...
        composeTestRule
            .onNodeWithText("v${AppBuildInfo.VERSION_NAME}", substring = true)
            .performClick()
    ...
    fun testStartupButtonsAndClickableIconsShowShortcutHintsOnlyWhenEnabled() {
        ...
        try {
            ...
            composeTestRule
                ...
                .assertHasClickAction()
            composeTestRule
                .onNodeWithContentDescription("Info about installation, license and privacy")
                .assertExists()
                .assertHasClickAction()
            composeTestRule
                .onNodeWithContentDescription("Send feedback")
                .assertExists()
                .assertHasClickAction()
            composeTestRule
