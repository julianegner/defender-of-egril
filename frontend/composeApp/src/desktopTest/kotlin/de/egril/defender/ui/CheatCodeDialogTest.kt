...
class CheatCodeDialogTest {
    ...
    fun testCheatCodeDialogRendersCorrectly() {
        ...
        composeTestRule
            .onNodeWithText("Cheat Code", substring = false, ignoreCase = false)
            .assertIsDisplayed()

        // Verify instruction text is displayed
        composeTestRule
            .onNodeWithText("Enter cheat code:", substring = true, ignoreCase = true)
            .assertExists()
        ...
        composeTestRule
            .onNodeWithText("Apply", substring = true, ignoreCase = true)
            .assertExists()
    ...
    fun testCheatCodeDialogInvalidCheatCode() {
        ...
        composeTestRule
            .onNodeWithText("Invalid cheat code", substring = true, ignoreCase = true)
            .assertExists()
            .assertIsDisplayed()
