...
class SettingsDialogTest {
    ...
    fun testSettingsDialogRendersCorrectly() {
        ...
        composeTestRule
            .onNodeWithText("Settings", substring = false, ignoreCase = false)
            .assertIsDisplayed()
        ...
        composeTestRule
            .onNodeWithText("Accessibility", substring = true, ignoreCase = true)
            .assertExists()
        composeTestRule
            .onNodeWithText("Shortcuts", substring = true, ignoreCase = true)
            .assertExists()
    ...
    fun testSettingsDialogAccessibilityInfoTexts() {
        ...
        composeTestRule
            .onNodeWithText("Increases contrast", substring = true, ignoreCase = true)
            .assertExists()
        composeTestRule
            .onNodeWithText("Shows text hints", substring = true, ignoreCase = true)
            .assertExists()
        composeTestRule
            .onNodeWithText("Requires holding", substring = true, ignoreCase = true)
            .assertExists()
