...
class SettingsHintBoxTest {
    ...
    fun testSettingsHintBoxShowsOnFirstRun() {
        ...
        composeTestRule
            .onNodeWithText("Settings Available", substring = true, ignoreCase = true)
            .assertExists()

        // Verify hint message is present
        composeTestRule
            .onNodeWithText("customize your experience", substring = true, ignoreCase = true)
            .assertExists()

        // Verify dismiss button exists
        composeTestRule
            .onNodeWithText("Got it!", substring = true, ignoreCase = true)
            .assertExists()
    ...
    fun testSettingsHintBoxListsAllSettings() {
        ...
        composeTestRule
            .onNodeWithText("Appearance", substring = true, ignoreCase = true)
            .assertExists()
        composeTestRule
            .onNodeWithText("Sound", substring = true, ignoreCase = true)
            .assertExists()
        composeTestRule
            .onNodeWithText("Controls", substring = true, ignoreCase = true)
            .assertExists()
        composeTestRule
            .onNodeWithText("Language", substring = true, ignoreCase = true)
            .assertExists()
        composeTestRule
            .onNodeWithText("Difficulty", substring = true, ignoreCase = true)
            .assertExists()
    }
}
