...
class StickerScreenTest {
    ...
    fun testStickerScreenRendersCorrectly() {
        ...
        try {
            composeTestRule
                .onNodeWithText("Game Map", substring = true, ignoreCase = true)
                .assertExists()
        } catch (e: AssertionError) {
        ...
        try {
            composeTestRule
                .onNodeWithText("Towers", substring = true, ignoreCase = true)
                .assertExists()
        } catch (e: AssertionError) {
        ...
        try {
            composeTestRule
                .onNodeWithText("Goblin", substring = true, ignoreCase = true)
                .assertExists()
        } catch (e: AssertionError) {
        ...
        try {
            composeTestRule
                .onNodeWithText("Ork", substring = true, ignoreCase = true)
                .assertExists()
        } catch (e: AssertionError) {
        ...
        try {
            composeTestRule
                .onNodeWithText("Wizard", substring = true, ignoreCase = true)
                .assertExists()
        } catch (e: AssertionError) {
        ...
        try {
            composeTestRule
                .onNodeWithText("Bow", substring = true, ignoreCase = true)
                .assertExists()
        } catch (e: AssertionError) {
