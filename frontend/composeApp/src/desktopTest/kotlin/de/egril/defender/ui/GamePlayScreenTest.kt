...
class GamePlayScreenTest {
    ...
    fun testGamePlayScreenWithThreeTowersAtTurn3() {
        ...
        val enemy1 =
            de.egril.defender.model.Attacker(
                id = 1,
    ...
    fun testGamePlayScreenLegendPanel() {
        ...
        try {
            composeTestRule
                .onNodeWithText("Legend", substring = true, ignoreCase = true)
                .performClick()
            composeTestRule.waitForIdle()
        } catch (e: Throwable) {
    ...
    fun testGamePlayScreenEnemiesPanelTurn1() {
        ...
        try {
            composeTestRule
                .onNodeWithText("Enemies", substring = true, ignoreCase = true)
                .performClick()
            composeTestRule.waitForIdle()
        } catch (e: Throwable) {
                ...
                buildAreas =
                    setOf(
                        ...
                        de.egril.defender.model
                            .Position(9, 3),
                        de.egril.defender.model
                            .Position(10, 3), // River tile that's also buildable
                        de.egril.defender.model
                            .Position(11, 3),
                        de.egril.defender.model
                            .Position(12, 3),
    ...
    fun testEndTurnWarningNotShownWhenNoEnemiesInRange() {
        ...
        try {
            composeTestRule
                .onNodeWithText("End Turn", substring = true, ignoreCase = true)
                .assertExists()
                .performClick()
    ...
    fun testEndTurnWarningShownForWizardWithTrapAbility() {
        ...
        try {
            ...
            assert(
                confirmationShown,
            ) { "End turn confirmation SHOULD be shown when wizard level 10+ has unused actions and trap is available" }
    ...
    fun testEndTurnNoWarningForWizardWithTrapOnCooldown() {
        ...
        try {
            ...
            assert(
                !confirmationShown,
            ) { "End turn confirmation should NOT be shown when wizard trap is on cooldown and no enemies in range" }
