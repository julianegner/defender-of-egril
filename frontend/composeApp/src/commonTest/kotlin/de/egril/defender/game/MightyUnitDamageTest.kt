...
class MightyUnitDamageTest {
    ...
    fun testSkeletonDealsSingleDamage() {
        ...
        assertEquals(
            1,
            skeleton.calculateTargetDamage(),
    ...
    fun testRedWitchDealsLevelDamage() {
        ...
        assertEquals(
            5,
            redWitch.calculateTargetDamage(),
    ...
    fun testGreenWitchDealsLevelDamage() {
        ...
        assertEquals(
            4,
            greenWitch.calculateTargetDamage(),
    ...
    fun testBlueDemonDealsLevelDamage() {
        ...
        assertEquals(
            7,
            blueDemon.calculateTargetDamage(),
    ...
    fun testRedDemonDealsLevelDamage() {
        ...
        assertEquals(
            8,
            redDemon.calculateTargetDamage(),
    ...
    fun testAllMightyUnitsAtLevel1() {
        ...
        for (type in mightyTypes) {
            ...
            assertEquals(
                1,
                attacker.calculateTargetDamage(),
