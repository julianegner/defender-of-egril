...
class AchievementSystemTest {
    ...
    fun testWinLevelAchievement() {
        ...
        assertTrue(
            awardedAchievements.any { it.id == AchievementId.WIN_LEVEL },
    ...
    fun testLoseLevelAchievement() {
        ...
        assertTrue(
            awardedAchievements.any { it.id == AchievementId.LOSE_LEVEL },
    ...
    fun testFlawlessVictoryAchievement() {
        ...
        assertTrue(
            awardedAchievements.any { it.id == AchievementId.WIN_LEVEL_FULL_HP },
    ...
    fun testCloseCallAchievement() {
        ...
        assertTrue(
            awardedAchievements.any { it.id == AchievementId.WIN_LEVEL_ONE_HP },
    ...
    fun testKillOgreAchievement() {
        ...
        assertTrue(
            awardedAchievements.any { it.id == AchievementId.KILL_OGRE },
    ...
    fun testKillEvilWizardAchievement() {
        ...
        assertTrue(
            awardedAchievements.any { it.id == AchievementId.KILL_EVIL_WIZARD },
    ...
    fun testKillDemonAchievement() {
        ...
        assertTrue(
            awardedAchievements.any { it.id == AchievementId.KILL_DEMON },
    ...
    fun testKillWitchAchievement() {
        ...
        assertTrue(
            awardedAchievements.any { it.id == AchievementId.KILL_WITCH },
    ...
    fun testKillDragonAchievement() {
        ...
        assertTrue(
            awardedAchievements.any { it.id == AchievementId.KILL_DRAGON },
    ...
    fun testKillTwoEnemiesSameTurnAchievement() {
        ...
        assertTrue(
            awardedAchievements.any { it.id == AchievementId.KILL_TWO_ENEMIES_SAME_TURN },
    ...
    fun testKillTwoEnemiesSameAttackAchievement() {
        ...
        assertTrue(
            awardedAchievements.any { it.id == AchievementId.KILL_TWO_ENEMIES_SAME_ATTACK },
    ...
    fun testAchievementPersistence() {
        ...
        assertTrue(
            profile.achievements.any { it.id == AchievementId.BUILD_TOWER },
            "Should have BUILD_TOWER achievement saved",
        )
        assertTrue(
            profile.achievements.any { it.id == AchievementId.BUILD_RAFT },
