...
class TowerPreviewCalculationTest {
    ...
    fun testDwarvenMinePreviewAtLevel141() {
        ...
        val nextRange =
            if (mine.type == DefenderType.DWARVEN_MINE) {
    ...
    fun testSpikeTowerPreviewAtLevel10() {
        ...
        val nextRange =
            if (tower.type == DefenderType.SPIKE_TOWER && nextLevel >= 5) {
        ...
        val nextActions =
            if (tower.type == DefenderType.SPIKE_TOWER) {
