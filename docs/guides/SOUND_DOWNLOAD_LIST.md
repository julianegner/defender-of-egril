# Sound File Download List

This document provides direct download URLs for all 19 game sound files from Freesound.org, along with attribution information.

## Download Instructions

1. Click on each "Download Page" URL below
2. Sign in to Freesound.org (create a free account if needed)
3. Click the **Download** button on the sound page
4. Save the file with the exact filename specified
5. If the file is not WAV format, convert it (instructions at bottom)
6. Place all files in: `composeApp/src/commonMain/composeResources/files/sounds/`
...
- **Description**: Sword hit metal sound
- **License**: Check on download page (typically CC-BY or CC0)
...
- **Author**: Erdie
- **Original Filename**: Will be shown on download page
- **Description**: Arrow/bow shooting sound
- **License**: Check on download page
...
- **Author**: IENBA
- **Original Filename**: Will be shown on download page
- **Description**: Explosion/fire/magic sound
- **License**: Check on download page
...
- **Author**: Nox_Sound
- **Original Filename**: Will be shown on download page
- **Description**: Acid sizzle/burn sound
- **License**: Check on download page
- **Use**: Lasting damage (Alchemy acid)
...
- **Author**: Reitanna
- **Original Filename**: Will be shown on download page
- **Description**: Monster growl/spawn sound
- **License**: Check on download page
- **Use**: Enemy spawning
...
- **Author**: FunWithSound
- **Original Filename**: Will be shown on download page
- **Description**: Footsteps/walking on stone
- **License**: Check on download page
- **Use**: Enemy movement
...
- **Author**: NenadSimic
- **Original Filename**: Will be shown on download page
- **Description**: Death/monster defeat sound
- **License**: Check on download page
- **Use**: Enemy destruction
...
- **Original Filename**: Will be shown on download page
- **Description**: Pickaxe/mining/digging sound
- **License**: Check on download page
...
- **License**: Check on download page
- **Use**: Dragon awakening from mine
...
- **Author**: Reitanna
- **Original Filename**: Will be shown on download page
- **Description**: Game lose/fail/negative sound
- **License**: Check on download page
...
- **Original Filename**: Will be shown on download page
- **Description**: Eating/chomping sound
- **License**: Check on download page
- **Use**: Dragon eating another unit
...
- **Author**: NenadSimic
- **Original Filename**: Will be shown on download page
- **Description**: Button click UI sound
- **License**: Check on download page
- **Use**: Button clicks
...
- **Author**: fins
- **Original Filename**: Will be shown on download page
- **Description**: Build/construction/placement sound
- **License**: Check on download page
- **Use**: Tower placement
...
- **Original Filename**: Will be shown on download page
- **Description**: Level up/success/achievement sound
- **License**: Check on download page
- **Use**: Tower upgrade
...
- **Author**: ProjectsU013
- **Original Filename**: Will be shown on download page
- **Description**: Cash register/coins/money sound
- **License**: Check on download page
- **Use**: Tower selling
...
- **Author**: Robinhood76
- **Original Filename**: Will be shown on download page
- **Description**: Trumpet/fanfare/horn
- **License**: Check on download page
- **Use**: Battle start (when "Start Battle" clicked)
...
### 2. Record Attribution Information

Create a file called `SOUND_CREDITS.md` in the repository root with the following format:
...
### attack_melee.wav
- **Author**: [Author name from download page]
...
# Batch convert
for file in *.wav; do
    sox "$file" -r 22050 -c 1 -b 16 "converted_$file"
done
```
...
5. Choose "Signed 16-bit PCM" encoding
...
# Fade out the last 0.1 seconds
ffmpeg -i input.wav -af "afade=t=out:st=0.4:d=0.1" output.wav
```
...
https://freesound.org/people/Nox_Sound/sounds/584209/
https://freesound.org/people/Reitanna/sounds/270385/
https://freesound.org/people/FunWithSound/sounds/744710/
https://freesound.org/people/NenadSimic/sounds/249816/
https://freesound.org/people/LegendOfZelda/sounds/635702/
https://freesound.org/people/stomachache/sounds/920/
https://freesound.org/people/Benboncan/sounds/12275/
https://freesound.org/people/scorpion67890/sounds/315793/
https://freesound.org/people/klankbeeld/sounds/242029/
https://freesound.org/people/MattRuthSound/sounds/712067/
https://freesound.org/people/NenadSimic/sounds/343000/
https://freesound.org/people/fins/sounds/271134/
https://freesound.org/people/Cabeeno_Rossley/sounds/528958/
https://freesound.org/people/ProjectsU013/sounds/451775/
https://freesound.org/people/Robinhood76/sounds/413203/
```
...
- **Note 1**: Sound #5 (enemy_spawn.wav) and #13 (life_lost.wav) currently point to the same URL. You may want to use an alternative for one of them.
- **Note 2**: Remember to check each sound's license on the download page and record attribution information.
- **Note 3**: Some sounds may need volume adjustment or trimming to fit the game better.
- **Note 4**: Test all sounds in-game before finalizing to ensure they work well together.

## Next Steps

After you've downloaded and prepared all the sound files:

1. Place them in `composeApp/src/commonMain/composeResources/files/sounds/`
2. Create `SOUND_CREDITS.md` with attribution information
3. Let me know, and I'll verify the integration and help with any adjustments needed
4. Test the sounds in-game (Settings → Enable Sound)
