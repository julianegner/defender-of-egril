...
This directory contains detailed documentation for the Defender of Egril project.
...
- Web/WASM guide (WEB_WASM_GUIDE.md)
...
- Map generation and editing features
- Waypoint editor
- Spiral and dance map implementations
- Tutorial save game extension
- Plurals usage
