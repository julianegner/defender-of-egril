...
export default function Template(props: TemplateProps<KcContext, I18n>) {
  ...
  const passwordGroupCss = `
    ...
    .kcFormPasswordVisibilityButtonClass{width:44px!important;height:100%!important;min-height:42px!important;padding:0!important;border:1px solid ${btnBorder}!important;border-radius:0 4px 4px 0!important;cursor:pointer!important;font-size:1rem!important;display:flex!important;align-items:center!important;justify-content:center!important;overflow:hidden!important;background-color:${btnBg}!important;color:${btnColor}!important}
