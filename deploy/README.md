...
| web page views – APP_STARTED Events (Last 100) | Table of the 100 most recent `APP_STARTED` events or events with a `url` value (web page views), including the `url` field |
