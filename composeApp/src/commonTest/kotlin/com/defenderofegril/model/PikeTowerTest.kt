...
class PikeTowerTest {
    ...
    fun testPikeTowerRangeProgression() {
        ...
        val tower20 = Defender(20, DefenderType.SPIKE_TOWER, position, mutableStateOf(20))
    ...
    fun testPikeTowerActionsPerTurn() {
        ...
        val tower9 = Defender(9, DefenderType.SPIKE_TOWER, position, mutableStateOf(9))
        ...
        val tower14 = Defender(14, DefenderType.SPIKE_TOWER, position, mutableStateOf(14))
        ...
        val tower15 = Defender(15, DefenderType.SPIKE_TOWER, position, mutableStateOf(15))
    ...
    fun testOtherTowersUnaffected() {
        ...
        val spear5 = Defender(1, DefenderType.SPEAR_TOWER, position, mutableStateOf(5))
        ...
        // Bow tower
        val bow10 = Defender(2, DefenderType.BOW_TOWER, position, mutableStateOf(10))
        ...
        // Wizard tower
        val wizard5 = Defender(3, DefenderType.WIZARD_TOWER, position, mutableStateOf(5))
