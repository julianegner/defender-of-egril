...
class DwarvenMineTest {
    ...
    fun testMineReach() {
        ...
        val mine35 = Defender(35, DefenderType.DWARVEN_MINE, position, mutableStateOf(35))
    ...
    fun testTrapDamage() {
        ...
        // Level 2: 15 damage
        val mine2 = Defender(2, DefenderType.DWARVEN_MINE, position, mutableStateOf(2))
    ...
    fun testDragonsLairCannotBeSold() {
        ...
        val lair = Defender(1, DefenderType.DRAGONS_LAIR, position)
