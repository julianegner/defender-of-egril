...
fun screenToHexGridPosition(
    ...
    val y = kotlin.math.round(yApprox + 0.35f).toInt()  // Rounding bias to fix accumulating error
    ...
    val x = kotlin.math.round(xApprox + 0.35f).toInt()  // Rounding bias to fix offset
